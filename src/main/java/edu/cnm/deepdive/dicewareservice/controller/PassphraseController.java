...
public class PassphraseController {
  ...
  public ResponseEntity<Passphrase> post(@RequestBody Passphrase passphrase, @RequestParam(value = "length", defaultValue = "6") int length) {
  ...
  public Passphrase put(@PathVariable long id, @RequestBody Passphrase passphrase) {
    ...
    //TODO Re-generate rando passphrase, if requested.
