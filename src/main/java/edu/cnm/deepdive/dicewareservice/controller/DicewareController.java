...
public class DicewareController {
  ...
  @PostMapping(value = "passphrases", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public Passphrase post(@RequestBody Passphrase passphrase, @RequestParam(value = "length", defaultValue = "6") int length) {
